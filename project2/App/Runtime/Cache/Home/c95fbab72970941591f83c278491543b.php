...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            ...
            <br>
            <br>
            <form method="post" action="http://localhost/eclipse/project2/index.php/Home/DongTai/inEdit">
                <div class="form-group">
                    <label for="p_title" class="sr-only">发表话题</label>
                    <input type="text" name = "title" class="form-control" id="p_title" placeholder="Title">
                </div>
                <div class="form-group">

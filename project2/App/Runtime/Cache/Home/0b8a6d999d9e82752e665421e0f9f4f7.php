...
<head>
	...
	<?php $url1="http://".C('URLSET')."/index.php/Home/History/addin"; ?>
	
</head>
<body style="background-color: #EDF2F1">
    <div class="container">
        <div class="row">
            <h2 align="center">添加成员</h2>
            <br>
            <br>
            ...
            <form class=" col-xs-offset-2 form-horizontal" action=<?php echo ($url1); ?> method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea rows="3" type="text" class="form-control" id="des" name="text" placeholder="Description"></textarea>
                    </div>
                </div>

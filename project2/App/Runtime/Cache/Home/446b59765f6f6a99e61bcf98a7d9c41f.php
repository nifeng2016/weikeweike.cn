...
<head>
    ...
    <?php $url2 = "http://".C('URLSET')."/index.php/Home/Video/uploadcls?name=".$name; ?>
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-5">
            <h4>上传视频</h4>
            <br>
            <form action=<?php echo ($url2); ?> method="post" enctype="multipart/form-data" class="form">
